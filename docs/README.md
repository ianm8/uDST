...
## DUC Block Diagram
![DUC Block Diagram](https://github.com/ianm8/uDST/blob/main/docs/uDST_DUC18_block_diagram.png?raw=true)
...
[This file](https://github.com/ianm8/uDST/blob/main/docs/uDST_How_It_Works.pdf) was provided by Brian W8BDM. He wanted to have a better understanding of how uDST worked so he got some help from AI and this file is the result. It is a very interesting and informative read. Thanks Brian!
