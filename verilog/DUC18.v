...
module upsampler_zero_stuff5_tx (
    input  wire clk,
    input  wire rst,
    ...
    // constants
    localparam integer OUT_DIV = 512;   // 80 MHz / 156.25 kHz
...
module fir_serial_tx #(
    ...
    // coefficient ROM (64 entries; [63]=0), Q15, ~x5 DC gain. Synchronous read.
    reg signed [15:0] Hmem [0:BUF_LEN-1];
    initial begin
        Hmem[0]=31;Hmem[1]=45;Hmem[2]=54;Hmem[3]=53;Hmem[4]=36;Hmem[5]=-3;Hmem[6]=-69;Hmem[7]=-166;Hmem[8]=-293;Hmem[9]=-446;
        Hmem[10]=-616;Hmem[11]=-789;Hmem[12]=-943;Hmem[13]=-1055;Hmem[14]=-1096;Hmem[15]=-1036;Hmem[16]=-847;Hmem[17]=-504;Hmem[18]=12;Hmem[19]=711;
        Hmem[20]=1593;Hmem[21]=2643;Hmem[22]=3835;Hmem[23]=5131;Hmem[24]=6482;Hmem[25]=7830;Hmem[26]=9113;Hmem[27]=10269;Hmem[28]=11239;Hmem[29]=11971;
        Hmem[30]=12427;Hmem[31]=12582;Hmem[32]=12427;Hmem[33]=11971;Hmem[34]=11239;Hmem[35]=10269;Hmem[36]=9113;Hmem[37]=7830;Hmem[38]=6482;Hmem[39]=5131;
        Hmem[40]=3835;Hmem[41]=2643;Hmem[42]=1593;Hmem[43]=711;Hmem[44]=12;Hmem[45]=-504;Hmem[46]=-847;Hmem[47]=-1036;Hmem[48]=-1096;Hmem[49]=-1055;
        Hmem[50]=-943;Hmem[51]=-789;Hmem[52]=-616;Hmem[53]=-446;Hmem[54]=-293;Hmem[55]=-166;Hmem[56]=-69;Hmem[57]=-3;Hmem[58]=36;Hmem[59]=53;
        Hmem[60]=54;Hmem[61]=45;Hmem[62]=31;Hmem[63]=0;
    end
...
module cic_interp_3rd_tx (
    ...
    localparam integer N=3, R=512, SCALE_SHIFT=18, AW=40;
...
module duc_top (
    ...
    // FIR output saturated to the 10-bit datapath. The FIR has ~x5 passband
    // gain (to compensate the x5 zero-stuffing), so firI/firQ can exceed the
    // 10-bit range; a bare [9:0] slice would wrap. Saturate instead.
    ...
    // -----------------------------
    // Upsampler (31.25 kHz → 156.25 kHz)
    // -----------------------------
    upsampler_zero_stuff5_tx u_upsampler (
        .clk       (clk),
        .rst       (rst),
        .in_valid  (in_valid),
